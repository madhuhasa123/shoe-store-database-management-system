...
<div id="wrapper_sec">
	<div id="masthead">
    	<div class="logo">
        	<a href="./index.php" class="logo-custom">Online Shoe Store</a>
        </div>
            ...
            <div class="navigation">
            	<div id="smoothmenu1" class="ddsmoothmenu">
					...
					<?php if($_SESSION['login'] != 1) {?>
						...
						<li><a href="./company-listing.php">All Company</a></li>
					...
					<?php if($_SESSION['user_details']['user_level_id'] == 2) {?>
						...
						<li><a href="#">Medicine Shopping</a>
							<ul>
								<li><a href="./product-listing.php">All Medicines</a></li>
								<li><a href="./company-listing.php">All Company</a></li>
								<li><a href="./type-listing.php">All Types</a></li>
							</ul>
						</li>
